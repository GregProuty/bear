...
export const SUPPORTED_CHAINS: Record<string, ChainConfig> = {
  ...
  base: {
    ...
    usdcAddress: '0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d', // Circle's official USDC (updated from coworker)
    vaultAddress: '0x858a8afff11bfccb61e69da87eba1ecccc34c640', // AaveVault on Base Sepolia (redeployed with Circle USDC)
  ...
  arbitrumSepolia: {
    ...
    aavePoolAddress: '0x6a9D64f93DB660EaCB2b6E9424792c630CdA87d8', // Arbitrum Sepolia AAVE V3 Pool (same as Base Sepolia)
    usdcAddress: '0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d', // Circle's official USDC on Arbitrum Sepolia testnet
    vaultAddress: '0xab686F6587345ccD11c353C0162743529E199edf', // NEW VAULT (agent: 0xEB72C74f...)
  ...
  optimismSepolia: {
    ...
    aavePoolAddress: '0x794a61358D6845594F94dc1DB02A252b5b4814aD', // Optimism Sepolia AAVE V3 Pool (same as Arbitrum Sepolia)
